...
const AuditLogSchema = new mongoose_1.Schema({
    ...
    changedBy: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", index: true },
    changedByType: { type: String, enum: ["user", "admin", "system"] },
    details: {
        previousValues: mongoose_1.Schema.Types.Mixed,
        newValues: mongoose_1.Schema.Types.Mixed,
        ipAddress: String,
        userAgent: String,
        notes: String,
    },
