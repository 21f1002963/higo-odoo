...
const BidSchema = new mongoose_1.Schema({
    ...
    bidderId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true, index: true },
...
exports.default = mongoose_1.default.models.Bid || mongoose_1.default.model("Bid", BidSchema);
