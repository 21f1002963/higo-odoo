...
const AdminActionSchema = new mongoose_1.Schema({
    ...
    target: {
        ...
        id: { type: mongoose_1.Schema.Types.ObjectId, required: true, index: true },
    },
...
exports.default = mongoose_1.default.models.AdminAction || mongoose_1.default.model("AdminAction", AdminActionSchema);
