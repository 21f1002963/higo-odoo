...
const ComplaintSchema = new mongoose_1.Schema({
    complainantId: { type: mongoose_1.Schema.Types.ObjectId, ref: "User", required: true, index: true },
    targetType: {
        type: String,
        required: true,
...
exports.default = mongoose_1.default.models.Complaint || mongoose_1.default.model("Complaint", ComplaintSchema);
