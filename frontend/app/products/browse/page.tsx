...
// Link component might not be directly needed here for the Select anymore,
// but it's good practice to keep it if other links exist or might be added.
...
// Select components are now used within CategorySelect
    ...
    <div className="container py-8">
      <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between mb-8">
        <div>
          ...
          <p className="text-muted-foreground">Discover sustainable second-hand items</p>
        </div>
